...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    >
      <motion.div className='text-stone-500 inline-flex
         text-center gap-2 bg-white px-6 py-1
      ...
      <motion.button onClick={onClickHandler} className=' cursor-pointer sm:text-lg text-white bg-black w-auto
