          ...
          <img src={assets.sample_img_1} alt="" className='w-80 xl:w-96
           ...
           <div className=''>
             ...
             <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge AI will 
                generate high-quality images in seconds. From product 
                visuals to character designs and potraits, even concepts
                that don't yet exist can be visualized effortlessly.
